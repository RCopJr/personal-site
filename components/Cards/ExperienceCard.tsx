...
const ExperienceCard = ({
  ...
  return (
    ...
    >
      <div className="mb-1 flex flex-wrap items-center justify-between text-base">
        <h1 className="text-slate-50">{company}</h1>
        <h3 className="text-sm">{date}</h3>
      </div>
      {/* <div className="mb-2 h-[1px] bg-gradient-to-r from-slate-100 via-slate-100 to-slate-950"></div> */}
      <h2 className="mb-4 text-base text-slate-400">{position}</h2>
